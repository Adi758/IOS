...
struct AppConstants{
    ...
    static let vehicles: [(String, String)] = [
        (brand: "AUDI", desc: "Audi is a German luxury car manufacturer that was founded in 1909. It has a long history of producing high-quality cars with advanced technology and innovative design."),
        (brand: "BMW", desc: "BMW is a German luxury car manufacturer that was founded in 1916. It has a reputation for producing high-performance, sporty cars with sleek designs and advanced technology."),
        (brand: "Duke", desc: "Duke is a brand of motorcycles produced by KTM, an Austrian motorcycle manufacturer. The Duke line was first introduced in 1994 with the Duke 620, and since then, it has become known for its lightweight, agile design and powerful engines. KTM has continued to innovate and expand the Duke lineup, offering a range of bikes suitable for both street and off-road riding."),
